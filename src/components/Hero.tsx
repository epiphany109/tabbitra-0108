      ...
      <div className="relative z-10 min-h-[70vh] bg-wood-dark flex flex-col items-center justify-center">
        <div className="text-center mb-12 pt-20">
          ...
          <div className="relative">
            ...
            <Button className="bg-accent hover:bg-accent-dark hover:scale-110 transition-transform duration-300 text-forest font-medium px-8 py-6 text-xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <Button className="bg-accent hover:bg-accent-dark hover:-translate-y-1 transition-all duration-300 text-forest font-medium px-8 py-6 text-xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
